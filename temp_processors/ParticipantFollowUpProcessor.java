...
@Component
public class ParticipantFollowUpProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ParticipantFollowUpProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ParticipantFollowUpProcessor(SerializerFactory serializerFactory) {
