...
@Component
public class ParticipantEligibilityProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ParticipantEligibilityProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ParticipantEligibilityProcessor(SerializerFactory serializerFactory) {
