...
@Component
public class StudyEnrollmentProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(StudyEnrollmentProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public StudyEnrollmentProcessor(SerializerFactory serializerFactory) {
