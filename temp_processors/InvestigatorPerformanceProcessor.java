...
@Component
public class InvestigatorPerformanceProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(InvestigatorPerformanceProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public InvestigatorPerformanceProcessor(SerializerFactory serializerFactory) {
