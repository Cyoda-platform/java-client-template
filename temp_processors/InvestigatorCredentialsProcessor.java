...
@Component
public class InvestigatorCredentialsProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(InvestigatorCredentialsProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public InvestigatorCredentialsProcessor(SerializerFactory serializerFactory) {
