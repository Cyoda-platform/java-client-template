...
@Component
public class ProtocolActivationProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ProtocolActivationProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ProtocolActivationProcessor(SerializerFactory serializerFactory) {
