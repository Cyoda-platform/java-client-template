...
@Component
public class ParticipantCompletionProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ParticipantCompletionProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ParticipantCompletionProcessor(SerializerFactory serializerFactory) {
