...
@Component
public class ParticipantConsentProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ParticipantConsentProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ParticipantConsentProcessor(SerializerFactory serializerFactory) {
