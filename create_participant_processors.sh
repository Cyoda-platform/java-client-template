...
# Create Participant processors
processors=(
    "ParticipantScreeningProcessor"
    "ParticipantEligibilityProcessor"
    "ParticipantScreenFailProcessor"
    "ParticipantConsentProcessor"
    "ParticipantWithdrawalProcessor"
    "ParticipantRandomizationProcessor"
    "ParticipantUpdateProcessor"
    "ParticipantVisitProcessor"
    "ParticipantAdverseEventProcessor"
    "ParticipantCompletionProcessor"
    "ParticipantFollowUpProcessor"
    "ParticipantClosureProcessor"
)
...
echo "Created Participant processors"
