package com.example.application.entity.product.version_1;
...
/**
 * Product Entity - Full OMS Product with comprehensive schema support
 * Implements the complete Product schema for e-commerce catalog management
 */
@Data
public class Product implements CyodaEntity {
    ...
    private String sku;  // Business ID - unique
    private String name;
    ...
    public boolean isValid(EntityMetadata metadata) {
        return sku != null && !sku.isBlank() && name != null && !name.isBlank() && 
               category != null && !category.isBlank() && price != null && quantityAvailable != null;
    }
