...
public class CyodaEntityControllerPrototype {
    ...
    private static final String ENTITY_NAME = "Booking"; // main entity with significant logic
    ...
    // Example usage of entityService for adding a Booking entity - this method is not exposed as endpoint but shown for illustration
    public UUID addBooking(Booking booking) throws ExecutionException, InterruptedException {
    ...
    // Example usage of entityService for updating a Booking entity
    public UUID updateBooking(UUID technicalId, Booking booking) throws ExecutionException, InterruptedException {
        ...
        return updatedIdFuture.get();
    }

    // Example usage of entityService for deleting a Booking entity
    public UUID deleteBooking(UUID technicalId) throws ExecutionException, InterruptedException {
        CompletableFuture<UUID> deletedIdFuture = entityService.deleteItem(
                ENTITY_NAME,
                ENTITY_VERSION,
                technicalId
        );
        return deletedIdFuture.get();
    }
