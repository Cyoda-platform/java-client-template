...
/**
 * ABOUTME: Virtual thread-based implementation of CalculationExecutionStrategy using
 * fixed thread pool with virtual threads for executing external calculation tasks.
 */
