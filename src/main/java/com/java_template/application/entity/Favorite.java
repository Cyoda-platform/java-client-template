...
public class Favorite implements CyodaEntity {
    private String id; // business ID - favoriteId
    private UUID technicalId; // database ID
    private String userId; // reference to user (UUID serialized as String)
    private String petId; // reference to pet (UUID serialized as String)
