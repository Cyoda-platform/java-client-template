...
/**
 * ABOUTME: Cart entity representing shopping cart functionality with line items,
 * totals calculation, guest contact information, and status management.
 */
@Data
public class Cart implements CyodaEntity {
    ...
    // Optional fields
    private GuestContact guestContact; // guest checkout information
