 ...
 * 
 * This entity represents a payment transaction with dummy processing
 * that auto-approves after ~3 seconds.
 * 
 * Payment States: INITIATED → PAID | FAILED | CANCELED
 */
@Data
public class Payment implements CyodaEntity {
    ...
    private String provider;               // required: "DUMMY"
