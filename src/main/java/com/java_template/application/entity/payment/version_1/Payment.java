...
/**
 * ABOUTME: Payment entity representing dummy payment processing
 * with auto-approval after 3 seconds for demo purposes.
 */
@Data
public class Payment implements CyodaEntity {
    ...
    private String paymentId; // Business ID - required, unique
    private String cartId; // Reference to cart - required
    private Double amount; // Payment amount - required
