...
/**
 * Payment entity for dummy payment processing in OMS
 * Supports payment initiation and auto-approval workflow
 */
@Data
public class Payment implements CyodaEntity {
    ...
    private String provider; // "DUMMY" for demo purposes
