 ...
 * Auto-transitions to PAID after ~3 seconds via processor
 */
@Data
public class Payment implements CyodaEntity {
    ...
    public boolean isValid(EntityMetadata metadata) {
        return paymentId != null && !paymentId.isBlank() && cartId != null && !cartId.isBlank() &&
               amount != null && status != null && !status.isBlank() && provider != null && !provider.isBlank();
    }
}
