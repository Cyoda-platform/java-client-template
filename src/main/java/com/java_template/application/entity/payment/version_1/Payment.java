...
/**
 * Payment Entity - Dummy payment implementation for OMS
 * 
 * This entity represents a payment transaction with:
 * - Payment identification and cart reference
 * - Payment amount and status
 * - Provider information (dummy for demo)
...
public class Payment implements CyodaEntity {
    ...
    // Required fields
    private String paymentId; // business identifier
