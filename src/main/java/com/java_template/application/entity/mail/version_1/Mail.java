 ...
 * The entity state is managed internally by the workflow system and represents 
 * the current state of the mail in the processing workflow.
 */
@Data
public class Mail implements CyodaEntity {
     ...
     * This field is part of the entity schema and represents the content mood of the mail
     */
    private Boolean isHappy;

    /**
     * List of email addresses to send the mail to
     * Must not be null, not empty, and all emails must be in valid format
     */
