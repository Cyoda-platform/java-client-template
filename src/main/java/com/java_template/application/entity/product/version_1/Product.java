...
/**
 * ABOUTME: This file contains the Product entity that represents catalog items
 * with comprehensive schema including attributes, variants, inventory, and compliance data.
 */
@Data
