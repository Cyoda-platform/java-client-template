 ...
 * Supports complex product data including variants, bundles, inventory, and compliance
 */
@Data
public class Product implements CyodaEntity {
    ...
    /**
     * Product localizations for different locales
     */
    @Data
    public static class ProductLocalizations {
        private String defaultLocale;
        private List<ProductLocalization> content;
    }
    ...
    /**
     * Product media including images and documents
     */
    @Data
    ...
    public static class ProductBundleComponent {
        private ProductBundleReference ref;
        private Integer qty;
    ...
    @Data
    public static class ProductBundleReference {
        private String sku;
    }
    ...
    /**
     * Product inventory management across multiple nodes
     */
    @Data
    ...
    /**
     * Product compliance and regulatory information
     */
    @Data
