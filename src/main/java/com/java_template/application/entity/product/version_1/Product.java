...
/**
 * Product Entity - Complete schema implementation for OMS
 * 
 * This entity represents a product with full schema including:
 * - Basic product information (sku, name, description, price, etc.)
 * - Attributes (brand, model, dimensions, weight, hazards, custom)
 * - Localizations with regulatory information
 * - Media attachments (images, documents)
 * - Options and variants with constraints
 * - Bundle configurations
 * - Inventory management across nodes
