...
/**
 * Product Entity - Complete e-commerce product with full schema support
 * 
 * This entity represents a product in the OMS system with comprehensive
 * support for variants, inventory, compliance, and complex business logic.
 */
@Data
