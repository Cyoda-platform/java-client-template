...
/**
 * Product entity implementing the full product schema as specified in requirements.
 * This entity supports complex product data including variants, bundles, inventory, etc.
 */
@Data
