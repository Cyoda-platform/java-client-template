...
/**
 * Product Entity - OMS Product Catalog
 * Implements the full Product schema as per requirements.
 */
@Data
public class Product implements CyodaEntity {
    ...
    public boolean isValid(EntityMetadata metadata) {
        return sku != null && !sku.isBlank() && name != null && !name.isBlank() && 
               price != null && quantityAvailable != null && category != null && !category.isBlank();
    }
