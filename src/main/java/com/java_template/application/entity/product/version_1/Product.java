 ...
 * 
 * Implements the complete product schema as specified in the requirements
 * including all nested structures for attributes, localizations, media,
 * options, variants, bundles, inventory, compliance, relationships, and events.
 */
@Data
