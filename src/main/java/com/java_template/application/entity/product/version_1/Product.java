...
/**
 * ABOUTME: Product entity representing a catalog item with comprehensive schema
 * including attributes, localizations, media, options, variants, bundles, inventory,
 * compliance, relationships, and events.
 */
@Data
