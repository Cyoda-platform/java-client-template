...
/**
 * Product Entity - Complete schema for catalog management
 * 
 * Represents catalog items with full product information including
...
public class Product implements CyodaEntity {
    ...
    private Double price;                  // required: default/base price
    ...
    /**
     * Multi-language content and regulatory information
     */
    @Data
    ...
    /**
     * Product variants with option values and overrides
     */
    @Data
    ...
    /**
     * Bundle configurations with components
     */
    @Data
    ...
    /**
     * Compliance documents and restrictions
     */
    @Data
    ...
    /**
     * Supplier contracts and related products
     */
    @Data
