 ...
 * 
 * Implements the complete product schema as specified in requirements
...
public class Product implements CyodaEntity {
    ...
    /**
     * Product attributes including brand, model, dimensions, weight, hazards, custom
     */
    @Data
    ...
    /**
     * Product localizations with default locale and content per locale
     */
    @Data
    ...
    /**
     * Product variants with option values, attributes, barcodes, pricing
     */
    @Data
    ...
    /**
     * Product inventory with nodes, policies
     */
    @Data
    ...
    /**
     * Product compliance with docs and restrictions
     */
    @Data
