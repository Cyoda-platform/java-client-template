...
public class Product implements CyodaEntity {
    ...
    public static class OptionConstraint {
        private Map<String, String> ifCondition; // "if" is reserved
        private ConstraintAction then;
        private List<RequirementRule> requires;
    ...
    @Data
    public static class RequirementRule {
    ...
    public static class InventoryNode {
        ...
        private List<InTransitItem> inTransit;
