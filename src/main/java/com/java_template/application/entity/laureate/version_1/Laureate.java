...
public class Laureate implements CyodaEntity {
    ...
    public boolean isValid() {
        return laureateId != null && !laureateId.isBlank() &&
               ...
               affiliationName != null && !affiliationName.isBlank() &&
               affiliationCity != null && !affiliationCity.isBlank() &&
               affiliationCountry != null && !affiliationCountry.isBlank() &&
               ingestedAt != null && !ingestedAt.isBlank();
    }
}
