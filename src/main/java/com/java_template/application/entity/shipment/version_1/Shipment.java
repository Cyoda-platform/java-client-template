...
/**
 * Shipment Entity - Shipment management implementation for OMS
 * 
 * This entity represents a shipment with:
 * - Shipment identification and order reference
 * - Shipment status and fulfillment state
 * - Line items with quantities (ordered, picked, shipped)
 * - Timestamps for tracking
 * 
 * States: PICKING → WAITING_TO_SEND → SENT → DELIVERED
 * 
 * Note: Single shipment per order for demo purposes
 */
@Data
public class Shipment implements CyodaEntity {
    ...
    // Required fields
    private String shipmentId; // business identifier
