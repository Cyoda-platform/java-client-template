...
/**
 * ABOUTME: This file contains the Shipment entity that represents shipment tracking
 * for order fulfillment with picking, shipping, and delivery status.
 */
@Data
public class Shipment implements CyodaEntity {
    ...
    /**
     * Shipment line item representing quantities for each SKU
     */
    @Data
