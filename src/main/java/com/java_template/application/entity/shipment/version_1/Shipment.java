...
/**
 * Shipment entity for tracking single shipment per order.
 * Manages picking, shipping, and delivery status.
 */
@Data
public class Shipment implements CyodaEntity {
    ...
    /**
     * Shipment line tracking quantities at different stages
     */
    @Data
