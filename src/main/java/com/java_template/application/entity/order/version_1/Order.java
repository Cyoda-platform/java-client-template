...
public class Order implements CyodaEntity {
    ...
    private String status; // "WAITING_TO_FULFILL" | "PICKING" | "WAITING_TO_SEND" | "SENT" | "DELIVERED" - Note: this maps to entity.meta.state
    ...
    public static class OrderTotals {
        ...
        private Double grand; // final total (items + tax + shipping - discounts)
    }
