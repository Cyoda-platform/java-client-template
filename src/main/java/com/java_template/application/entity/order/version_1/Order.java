...
/**
 * Order Entity - Order management implementation for OMS
 * 
 * This entity represents an order with:
 * - Order identification and number (short ULID)
...
public class Order implements CyodaEntity {
    ...
    /**
     * Address information for shipping (required for orders)
     */
    @Data
