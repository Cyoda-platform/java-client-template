...
/**
 * Order entity representing a confirmed order with fulfillment tracking.
 * Created from a paid cart with snapshot of cart data.
 * 
...
public class Order implements CyodaEntity {
    ...
    /**
     * Address information (required for orders)
     */
    @Data
