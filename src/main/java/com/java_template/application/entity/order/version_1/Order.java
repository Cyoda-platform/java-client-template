...
/**
 * ABOUTME: Order entity representing confirmed orders with line items, totals, and customer contact
 * information for fulfillment and tracking purposes.
 */
@Data
public class Order implements CyodaEntity {
    ...
    public static class OrderTotals {
        private Double items; // Subtotal of all items
    ...
    public static class GuestContact {
        ...
        private GuestAddress address; // Required for orders
