...
public class UserController {
    ...
    @Operation(summary = "Get User", description = "Retrieve User by technicalId. Users are produced/managed by ingestion workflows.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> getUser(@Parameter(name = "technicalId", description = "Technical ID of the entity") @PathVariable String technicalId) {
        try {
            ...
            if (item == null) {
                throw new NoSuchElementException("User not found: " + technicalId);
            }
            ...
            if (cause instanceof NoSuchElementException) {
                ...
                logger.error("Execution exception getting user", ee);
