 ...
 * Handles clinical trial submission operations
 */
@RestController
...
public class SubmissionController {
    ...
    /**
     * Get submission by business identifier
     ...
     * GET /ui/submissions/search?studyType=clinical_trial
     */
    @GetMapping("/search")
    public ResponseEntity<List<EntityWithMetadata<Submission>>> searchSubmissionsByStudyType(
        ...
        try {
            ...
            SimpleCondition simpleCondition = new SimpleCondition()
                    ...
                    .withValue(objectMapper.valueToTree(studyType));
            ...
            logger.error("Error searching submissions by study type: {}", studyType, e);
            return ResponseEntity.badRequest().build();
        }
    }

    /**
     * Advanced search for submissions
     * POST /ui/submissions/search/advanced
     */
    @PostMapping("/search/advanced")
    public ResponseEntity<List<EntityWithMetadata<Submission>>> advancedSearch(
    ...
    /**
     * Submit submission for review (workflow transition)
    ...
    public ResponseEntity<EntityWithMetadata<Submission>> submitForReview(@PathVariable UUID id) {
        try {
            ...
            Submission submission = current.entity();
            submission.setUpdatedAt(LocalDateTime.now());
