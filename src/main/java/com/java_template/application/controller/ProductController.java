...
/**
 * ABOUTME: This file contains the ProductController that exposes REST APIs for product catalog
 * management including search, filtering, and CRUD operations for the browser UI.
 */
@RestController
...
public class ProductController {
    ...
    public ResponseEntity<?> createProduct(@RequestBody Product product) {
        try {
            ...
            logger.info("Product created with SKU: {} and ID: {}", product.getSku(), response.metadata().getId());
