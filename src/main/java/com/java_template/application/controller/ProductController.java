...
/**
 * ABOUTME: REST controller for Product entity with search, filter, and CRUD operations.
 */
@RestController
...
public class ProductController {
     ...
     * GET /ui/products/{sku}
     * Returns full Product document with all schema fields
     */
    @GetMapping("/{sku}")
    ...
    /**
     * List products with search, category filter, and price range filter
