...
public class Controller {
    ...
    public ResponseEntity<Map<String, String>> createWorkflow(@RequestBody Workflow workflow) throws ExecutionException, InterruptedException {
        try {
    ...
    public ResponseEntity<Workflow> getWorkflow(@PathVariable("id") String id) throws ExecutionException, InterruptedException, JsonProcessingException {
        try {
    ...
    public ResponseEntity<DataDownload> getDataDownload(@PathVariable("id") String id) throws ExecutionException, InterruptedException, JsonProcessingException {
        try {
            UUID technicalId = UUID.fromString(id);
            CompletableFuture<ObjectNode> itemFuture = entityService.getItem(
            ...
            DataDownload dataDownload = objectMapper.treeToValue(node, DataDownload.class);
    ...
    public ResponseEntity<ReportEmail> getReportEmail(@PathVariable("id") String id) throws ExecutionException, InterruptedException, JsonProcessingException {
        try {
            UUID technicalId = UUID.fromString(id);
            CompletableFuture<ObjectNode> itemFuture = entityService.getItem(
            ...
            ReportEmail reportEmail = objectMapper.treeToValue(node, ReportEmail.class);
