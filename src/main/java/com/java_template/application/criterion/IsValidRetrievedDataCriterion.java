...
@Component
public class IsValidRetrievedDataCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;

    public IsValidRetrievedDataCriterion(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("IsValidRetrievedDataCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "IsValidRetrievedDataCriterion".equals(modelSpec.operationName()) &&
    ...
    private EvaluationOutcome validateEntity(DigestData entity) {
        ...
        if (entity.getFormatType() == null || entity.getFormatType().isBlank()) {
            return EvaluationOutcome.fail("Format type is required", StandardEvalReasonCategories.VALIDATION_FAILURE);
        }
