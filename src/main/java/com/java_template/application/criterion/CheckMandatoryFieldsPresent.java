...
@Component
public class CheckMandatoryFieldsPresent implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public CheckMandatoryFieldsPresent(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<HackerNewsItem> context) {
         ...
         if (entity.getId() == null) {
             return EvaluationOutcome.fail("Mandatory field 'id' is missing", StandardEvalReasonCategories.VALIDATION_FAILURE);
         }
         if (entity.getType() == null || entity.getType().isEmpty()) {
             return EvaluationOutcome.fail("Mandatory field 'type' is missing", StandardEvalReasonCategories.VALIDATION_FAILURE);
         }
