...
@Component
public class InvalidActionTypeCriterion implements CyodaCriterion {
    ...
    public InvalidActionTypeCriterion(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("InvalidActionTypeCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "InvalidActionTypeCriterion".equals(modelSpec.operationName()) &&
    ...
    private EvaluationOutcome validateEntity(PurrfectPetsJob entity) {
        ...
        if (VALID_ACTIONS.contains(entity.getActionType())) {
            return EvaluationOutcome.fail("Action type should be invalid: " + entity.getActionType(), StandardEvalReasonCategories.VALIDATION_FAILURE);
        }
