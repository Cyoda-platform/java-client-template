...
@Component
public class IsDigestRequestJobFailedCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;

    public IsDigestRequestJobFailedCriterion(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("IsDigestRequestJobFailedCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "IsDigestRequestJobFailedCriterion".equals(modelSpec.operationName()) &&
    ...
    private EvaluationOutcome validateEntity(DigestRequestJob entity) {
        ...
        if (!entity.getStatus().name().equals("FAILED")) {
