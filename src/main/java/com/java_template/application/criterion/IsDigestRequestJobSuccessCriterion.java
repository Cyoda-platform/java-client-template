...
@Component
public class IsDigestRequestJobSuccessCriterion implements CyodaCriterion {

    private final org.slf4j.Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;

    public IsDigestRequestJobSuccessCriterion(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("IsDigestRequestJobSuccessCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "IsDigestRequestJobSuccessCriterion".equals(modelSpec.operationName()) &&
    ...
    private EvaluationOutcome validateEntity(DigestRequestJob entity) {
        ...
        if (!entity.getStatus().name().equals("COMPLETED")) {
