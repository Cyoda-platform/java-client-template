...
public class DigestRequestJobValidationFailCriterion implements CyodaCriterion {
    ...
    public DigestRequestJobValidationFailCriterion(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("DigestRequestJobValidationFailCriterion initialized with SerializerFactory");
    }
