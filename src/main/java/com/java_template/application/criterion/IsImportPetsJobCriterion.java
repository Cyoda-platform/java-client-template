...
@Component
public class IsImportPetsJobCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;

    public IsImportPetsJobCriterion(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("IsImportPetsJobCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "IsImportPetsJobCriterion".equals(modelSpec.operationName()) &&
    ...
    private EvaluationOutcome validateEntity(PurrfectPetsJob entity) {
        ...
        if (!"ImportPets".equals(entity.getType())) {
            return EvaluationOutcome.fail("Job type must be 'ImportPets'", StandardEvalReasonCategories.BUSINESS_RULE_FAILURE);
        }
