...
@Component
public class IsValidEmailCriterion implements CyodaCriterion {
    ...
    public IsValidEmailCriterion(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("IsValidEmailCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "IsValidEmailCriterion".equals(modelSpec.operationName()) &&
