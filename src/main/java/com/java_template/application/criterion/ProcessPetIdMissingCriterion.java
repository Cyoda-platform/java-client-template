...
@Component
public class ProcessPetIdMissingCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;

    public ProcessPetIdMissingCriterion(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("ProcessPetIdMissingCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "ProcessPetIdMissingCriterion".equals(modelSpec.operationName()) &&
    ...
    private EvaluationOutcome validateEntity(PetJob entity) {
        ...
        if (entity.getPetId() == null) {
            return EvaluationOutcome.fail("Pet ID is missing for PROCESS operation", StandardEvalReasonCategories.VALIDATION_FAILURE);
        }
