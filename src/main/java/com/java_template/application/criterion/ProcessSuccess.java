...
@Component
public class ProcessSuccess implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public ProcessSuccess(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<WeatherRequest> context) {
        ...
        // Here, let's assume the processing success means the entity has a requestTimestamp set and isValid() returns true
        if (entity.getRequestTimestamp() == null) {
            return EvaluationOutcome.fail("requestTimestamp must be set for successful processing", StandardEvalReasonCategories.VALIDATION_FAILURE);
        }
