...
@Component
public class FetchDataSuccessCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public FetchDataSuccessCriterion(SerializerFactory serializerFactory) {
    ...
    public EntityCriteriaCalculationResponse check(CyodaEventContext<EntityCriteriaCalculationRequest> context) {
        ...
        return serializer.withRequest(request)
            .evaluateEntity(DigestDataRecord.class, this::validateEntity)
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<DigestDataRecord> context) {
        ...
        if (entity.getFetchedAt() == null || entity.getFetchedAt().isBlank()) {
            return EvaluationOutcome.fail("fetchedAt is required", StandardEvalReasonCategories.VALIDATION_FAILURE);
        }
