...
@Component
public class CommentIngestionJobProcessingSuccessCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;

    public CommentIngestionJobProcessingSuccessCriterion(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("CommentIngestionJobProcessingSuccessCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "CommentIngestionJobProcessingSuccessCriterion".equals(modelSpec.operationName()) &&
