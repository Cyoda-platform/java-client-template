...
public class JobSuccessCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Job> context) {
         ...
         // Validate that the job status is 'completed' and there is a non-null resultDetails indicating success
         ...
         if (job.getResultDetails() == null || job.getResultDetails().isBlank()) {
            return EvaluationOutcome.fail("Result details must be provided for a successful job", StandardEvalReasonCategories.VALIDATION_FAILURE);
         }
