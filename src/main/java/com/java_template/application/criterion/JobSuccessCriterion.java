...
public class JobSuccessCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Job> context) {
        ...
        // Success condition: job status is SUCCEEDED
        if (!"SUCCEEDED".equalsIgnoreCase(job.getStatus())) {
            return EvaluationOutcome.fail("Job ingestion not successful", StandardEvalReasonCategories.BUSINESS_RULE_FAILURE);
        }
