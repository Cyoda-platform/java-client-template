...
public class JobSuccessCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Job> context) {
        ...
        if ("COMPLETED".equalsIgnoreCase(job.getStatus()) || "SUCCESS".equalsIgnoreCase(job.getStatus())) {
            return EvaluationOutcome.success();
        }

        return EvaluationOutcome.fail("Job not completed", StandardEvalReasonCategories.BUSINESS_RULE_FAILURE);
    }
}
