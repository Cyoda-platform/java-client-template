...
public class CheckIngestSuccessCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Job> context) {
         ...
         // Use available getters/setters from Job (generated by Lombok in entity).
         ...
         // This criterion applies when the job is in INGESTING state (exact match).
         if (!"INGESTING".equals(job.getStatus())) {
