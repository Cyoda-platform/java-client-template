...
public class DigestRequestJobValidationCriterion implements CyodaCriterion {
    ...
    public DigestRequestJobValidationCriterion(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("DigestRequestJobValidationCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "DigestRequestJobValidationCriterion".equals(modelSpec.operationName()) &&
    ...
    private EvaluationOutcome validateEntity(DigestRequestJob entity) {
        ...
        if (!entity.getEmail().matches("^[\\w.%+-]+@[\\w.-]+\\.[a-zA-Z]{2,6}$")) {
