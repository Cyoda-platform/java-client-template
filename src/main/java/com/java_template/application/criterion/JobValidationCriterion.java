...
public class JobValidationCriterion implements CyodaCriterion {
    ...
    public JobValidationCriterion(SerializerFactory serializerFactory) {
        ...
        logger.info("JobValidationCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "JobValidationCriterion".equals(modelSpec.operationName()) &&
    ...
    private EvaluationOutcome validateEntity(ProductPerformanceJob entity) {
        ...
        if (entity.getEmailRecipient() == null || entity.getEmailRecipient().isBlank() || !entity.getEmailRecipient().matches("^[\\w.%+-]+@[\\w.-]+\\.[a-zA-Z]{2,6}$")) {
            return EvaluationOutcome.fail("Email recipient is not valid", StandardEvalReasonCategories.VALIDATION_FAILURE);
        }
