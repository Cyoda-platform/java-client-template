...
@Component
public class GloomyKeywordCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public GloomyKeywordCriterion(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Mail> context) {
        ...
        if (subject.contains("sad") || body.contains("sad") || body.contains("gloomy") || body.contains("unhappy")) {
            return EvaluationOutcome.success();
        }
        return EvaluationOutcome.fail("No gloomy keywords", StandardEvalReasonCategories.DATA_QUALITY_FAILURE);
    }
}
