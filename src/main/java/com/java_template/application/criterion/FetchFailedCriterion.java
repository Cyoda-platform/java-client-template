...
public class FetchFailedCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<ExtractionJob> context) {
        ...
        if (job.getFailureReason() != null && job.getFailureReason().equals("FETCH_ENDPOINT_FAILURE")) {
            return EvaluationOutcome.fail("Fetch failures recorded", StandardEvalReasonCategories.BUSINESS_RULE_FAILURE);
        }
