...
@Component
public class ProcessFailure implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public ProcessFailure(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<WeatherRequest> context) {
        ...
        // Processing failure implies either missing requestTimestamp or invalid entity
        ...
        return EvaluationOutcome.fail("Processing succeeded", StandardEvalReasonCategories.VALIDATION_FAILURE);
    }
}
