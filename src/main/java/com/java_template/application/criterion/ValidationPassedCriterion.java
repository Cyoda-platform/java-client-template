...
public class ValidationPassedCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<HNItem> context) {
         ...
         // Validate presence of required fields according to functional requirements: id and type
         ...
         if (!missing.isEmpty()) {
             String message = "Missing or invalid required fields: " + String.join(", ", missing);
             logger.debug("Validation failed for HNItem id={} : {}", entity.getId(), message);
