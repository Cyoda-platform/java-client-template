...
@Component
public class IsRetryAllowedCriterion implements CyodaCriterion {
    ...
    public IsRetryAllowedCriterion(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Mail> context) {
        ...
        return EvaluationOutcome.fail("Max retries exceeded", StandardEvalReasonCategories.BUSINESS_RULE_FAILURE);
    }
}