...
@Component
public class DigestRequestJobIsValidRequestCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public DigestRequestJobIsValidRequestCriterion(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<DigestRequestJob> context) {
        ...
        // Validate userEmail presence and valid email format
        ...
        // Basic email validation pattern (simple check)
