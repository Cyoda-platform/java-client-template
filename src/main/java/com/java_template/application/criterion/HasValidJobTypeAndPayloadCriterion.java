...
@Component
public class HasValidJobTypeAndPayloadCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;

    public HasValidJobTypeAndPayloadCriterion(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("HasValidJobTypeAndPayloadCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "HasValidJobTypeAndPayloadCriterion".equals(modelSpec.operationName()) &&
