...
public class PersistErrorCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Laureate> context) {
        ...
        if (l.getStatus() != null && "REJECTED".equalsIgnoreCase(l.getStatus())) {
            return EvaluationOutcome.fail("Laureate persistence failed or rejected", StandardEvalReasonCategories.BUSINESS_RULE_FAILURE);
        }
