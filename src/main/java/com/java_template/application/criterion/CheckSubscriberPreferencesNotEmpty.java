...
@Component
public class CheckSubscriberPreferencesNotEmpty implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public CheckSubscriberPreferencesNotEmpty(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Subscriber> context) {
         ...
         if (subscriber.getPreferredPetTypes() == null || subscriber.getPreferredPetTypes().isEmpty()) {
             return EvaluationOutcome.fail("Preferred pet types list cannot be empty", StandardEvalReasonCategories.VALIDATION_FAILURE);
         }
