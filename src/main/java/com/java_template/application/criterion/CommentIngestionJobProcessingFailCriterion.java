...
@Component
public class CommentIngestionJobProcessingFailCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;

    public CommentIngestionJobProcessingFailCriterion(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("CommentIngestionJobProcessingFailCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "CommentIngestionJobProcessingFailCriterion".equals(modelSpec.operationName()) &&
