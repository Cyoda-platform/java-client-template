...
public class IngestionFailureCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Job> context) {
         ...
         // Validate that the job status is FAILED and resultSummary is not empty
         ...
         if (job.getResultSummary() == null || job.getResultSummary().trim().isEmpty()) {
            return EvaluationOutcome.fail("Result summary must be provided for failed jobs", StandardEvalReasonCategories.VALIDATION_FAILURE);
         }
