...
public class ImportErrorCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<ImportJob> context) {
        ...
        if (job == null) {
            return EvaluationOutcome.fail("Job is null", StandardEvalReasonCategories.DATA_QUALITY_FAILURE);
        }
        ...
        return EvaluationOutcome.fail("No import error detected", StandardEvalReasonCategories.BUSINESS_RULE_FAILURE);
    }
}
