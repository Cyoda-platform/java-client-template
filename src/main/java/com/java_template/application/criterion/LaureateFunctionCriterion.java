...
@Component
public class LaureateFunctionCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public LaureateFunctionCriterion(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Laureate> context) {
         ...
         if (laureate.getBorn() != null && laureate.getDied() != null && laureate.getBorn().isAfter(laureate.getDied())) {
            return EvaluationOutcome.fail("Born date must be before died date", StandardEvalReasonCategories.BUSINESS_RULE_FAILURE);
         }
