...
@Component
public class IsPetJobInvalid implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;

    public IsPetJobInvalid(SerializerFactory serializerFactory) {
        this.serializer = serializerFactory.getDefaultCriteriaSerializer();
        logger.info("IsPetJobInvalid initialized with SerializerFactory");
    }
    ...
    private EvaluationOutcome validateEntity(PetJob entity) {
        ...
        // Validate: payload must be non-null and non-blank
