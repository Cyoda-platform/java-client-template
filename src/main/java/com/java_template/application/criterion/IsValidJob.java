...
@Component
public class IsValidJob implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public IsValidJob(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<SnapshotJob> context) {
        ...
        // Validate dateRangeStart and dateRangeEnd are present
        ...
        // Validate that dateRangeStart is before dateRangeEnd
