...
public class JobFailedCriterion implements CyodaCriterion {
    ...
    public JobFailedCriterion(SerializerFactory serializerFactory) {
        ...
        logger.info("JobFailedCriterion initialized with SerializerFactory");
    }
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "JobFailedCriterion".equals(modelSpec.operationName()) &&
    ...
    private EvaluationOutcome validateEntity(PurrfectPetsJob entity) {
        // Business rule: job status must be FAILED
