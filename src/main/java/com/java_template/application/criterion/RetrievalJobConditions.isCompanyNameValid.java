...
@Component
public class RetrievalJobConditions.isCompanyNameValid implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public RetrievalJobConditions.isCompanyNameValid(SerializerFactory serializerFactory) {
