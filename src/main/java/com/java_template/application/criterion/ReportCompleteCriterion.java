...
public class ReportCompleteCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<AnalysisReport> context) {
        ...
        if ("READY".equalsIgnoreCase(report.getStatus())) return EvaluationOutcome.success();
        return EvaluationOutcome.fail("Report not READY", StandardEvalReasonCategories.VALIDATION_FAILURE);
    }
}
