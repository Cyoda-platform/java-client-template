...
public class PetExistsCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(Pet pet) {
        // Check if the petId is present, indicating the pet exists in the system
        if (pet.getPetId() == null) {
            return EvaluationOutcome.fail("Pet does not exist (petId is null)", StandardEvalReasonCategories.DATA_QUALITY_FAILURE);
        }
