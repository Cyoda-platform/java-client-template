...
public class CatFactRetrieved implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<WeeklyCatFactJob> context) {
        ...
        // Business logic: catFact should not be null or blank
        if (entity.getCatFact() == null || entity.getCatFact().isBlank()) {
            return EvaluationOutcome.fail("CatFact not retrieved", StandardEvalReasonCategories.DATA_QUALITY_FAILURE);
        }
