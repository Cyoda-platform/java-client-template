...
@Component
public class EmailFormatCriterion implements CyodaCriterion {
    ...
    public EmailFormatCriterion(SerializerFactory serializerFactory) {
    ...
    public EntityCriteriaCalculationResponse check(CyodaEventContext<EntityCriteriaCalculationRequest> context) {
        ...
        return serializer.withRequest(request)
            .evaluateEntity(Recipient.class, this::validateEntity)
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Recipient> context) {
        ...
        if (r.getEmail() == null || !EMAIL_PATTERN.matcher(r.getEmail()).matches()) {
