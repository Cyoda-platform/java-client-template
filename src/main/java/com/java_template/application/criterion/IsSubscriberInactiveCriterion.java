...
@Component
public class IsSubscriberInactiveCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public IsSubscriberInactiveCriterion(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Subscriber> context) {
        ...
        if (entity.getActive() == null || !entity.getActive()) {
            ...
            return EvaluationOutcome.fail("Subscriber is still active", StandardEvalReasonCategories.BUSINESS_RULE_FAILURE);
        }
    }
}
