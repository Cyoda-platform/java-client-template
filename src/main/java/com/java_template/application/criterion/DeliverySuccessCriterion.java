...
public class DeliverySuccessCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<DeliveryRecord> context) {
        ...
        if ("SUCCESS".equalsIgnoreCase(s)) return EvaluationOutcome.success();
        return EvaluationOutcome.fail("Not successful: " + s, StandardEvalReasonCategories.DATA_QUALITY_FAILURE);
    }
}
