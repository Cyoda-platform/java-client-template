...
public class FetchSuccessCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Job> context) {
        ...
        if (job.getStatus() == null || !"IN_PROGRESS".equalsIgnoreCase(job.getStatus())) {
            return EvaluationOutcome.fail("Job status is not IN_PROGRESS", StandardEvalReasonCategories.BUSINESS_RULE_FAILURE);
        }
