...
@Component
public class CheckMailGloomyCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public CheckMailGloomyCriterion(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Mail> context) {
        ...
        if (entity == null || entity.getIsHappy() == null) {
            return EvaluationOutcome.fail("Mail entity or 'isHappy' field is null.", StandardEvalReasonCategories.VALIDATION_FAILURE);
        }
