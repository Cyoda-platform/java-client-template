...
@Component
public class PricePresentCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public PricePresentCriterion(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<InventoryItem> context) {
        ...
        if (entity.getUnitPrice() == null) {
            return EvaluationOutcome.fail("UnitPrice is missing", StandardEvalReasonCategories.DATA_QUALITY_FAILURE);
        }
