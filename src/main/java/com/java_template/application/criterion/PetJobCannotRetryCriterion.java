...
public class PetJobCannotRetryCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(Pet entity) {
        // Cannot retry if status is not FAILED
        ...
        return EvaluationOutcome.fail("Pet status is FAILED, cannot abort", StandardEvalReasonCategories.BUSINESS_RULE_FAILURE);
    }
}
