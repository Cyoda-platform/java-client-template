...
@Component
public class DigestRequestJobIsNotValidRequestCriterion implements CyodaCriterion {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final CriterionSerializer serializer;
    private final String className = this.getClass().getSimpleName();

    public DigestRequestJobIsNotValidRequestCriterion(SerializerFactory serializerFactory) {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<DigestRequestJob> context) {
        ...
        // This criterion is the negation of DigestRequestJobIsValidRequestCriterion
        ...
        return EvaluationOutcome.fail("Request is valid, this criterion expects invalid request", StandardEvalReasonCategories.VALIDATION_FAILURE);
    }
}
