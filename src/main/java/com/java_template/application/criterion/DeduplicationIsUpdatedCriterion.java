...
public class DeduplicationIsUpdatedCriterion implements CyodaCriterion {
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<Laureate> context) {
         ...
         // Interpret "UPDATED" as candidate that has been associated with an existing persisted record context:
         // we require both sourceJobId and createdAt to be present to treat it as an update candidate.
