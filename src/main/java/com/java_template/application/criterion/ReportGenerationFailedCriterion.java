...
public class ReportGenerationFailedCriterion implements CyodaCriterion {
    ...
    public boolean supports(OperationSpecification modelSpec) {
        // Must use the exact criterion name
        return modelSpec != null && "ReportGenerationFailedCriterion".equals(modelSpec.operationName());
    }
    ...
    private EvaluationOutcome validateEntity(CriterionSerializer.CriterionEntityEvaluationContext<WeeklyReport> context) {
         ...
         // If report is still generating or in other non-failed states, consider it a success for this criterion
