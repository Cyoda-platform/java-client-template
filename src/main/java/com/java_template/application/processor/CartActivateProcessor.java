...
@Component
public class CartActivateProcessor implements CyodaProcessor {

    private static final Logger logger = LoggerFactory.getLogger(CartActivateProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public CartActivateProcessor(SerializerFactory serializerFactory) {
    ...
    private Cart processCartActivation(ProcessorSerializer.ProcessorEntityExecutionContext<Cart> context) {
        ...
        logger.info("Activating cart: {}", cart.getCartId());
