 ...
 * Handles order cancellation and cleanup
 */
@Component
public class OrderCancellationProcessor implements CyodaProcessor {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        logger.info("Processing OrderCancellation for request: {}", request.getId());
    ...
    private EntityWithMetadata<Order> cancelOrder(
        ...
        order.setCancellationReason("User requested cancellation");
