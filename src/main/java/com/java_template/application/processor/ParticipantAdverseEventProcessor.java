...
@Component
public class ParticipantAdverseEventProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ParticipantAdverseEventProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ParticipantAdverseEventProcessor(SerializerFactory serializerFactory) {
