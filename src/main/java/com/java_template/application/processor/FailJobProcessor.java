...
public class FailJobProcessor implements CyodaProcessor {
    ...
    public FailJobProcessor(SerializerFactory serializerFactory, EntityService entityService) {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        logger.info("Processing FailJob for request: {}", request.getId());
    ...
    private Job processEntityLogic(ProcessorSerializer.ProcessorEntityExecutionContext<Job> context) {
        ...
        try {
            ...
            logger.error("Error while marking job failed {}: {}", technicalId, e.getMessage());
        }
        return job;
    }
}
