...
@Component
public class ProtocolSubmissionProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ProtocolSubmissionProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ProtocolSubmissionProcessor(SerializerFactory serializerFactory) {
