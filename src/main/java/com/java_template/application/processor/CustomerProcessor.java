...
/**
 * ABOUTME: Processor for Customer entity lifecycle management.
 * Handles customer creation and update workflows with timestamp management.
 */
@Component
public class CustomerProcessor implements CyodaProcessor {
    ...
    /**
     * Main business logic for customer processing
     */
    private EntityWithMetadata<Customer> processCustomerLogic(
        ...
        logger.info("Customer {} processed successfully", customer.getCustomerId());
