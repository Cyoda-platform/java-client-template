...
/**
 * Processor for approving submissions
 */
@Component
public class ApprovalProcessor implements CyodaProcessor {
    ...
    private EntityWithMetadata<Submission> processApproval(
        ...
        processApprovalDecision(submission);
    ...
    private void processApprovalDecision(Submission submission) {
        // Log approval decision
        logger.info("Submission {} has been approved", submission.getSubmissionId());
        
        // Prepare for study activation
        logger.info("Preparing submission {} for study activation", submission.getSubmissionId());
    }
}
