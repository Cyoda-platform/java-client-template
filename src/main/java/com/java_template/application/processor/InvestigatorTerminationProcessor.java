...
@Component
public class InvestigatorTerminationProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(InvestigatorTerminationProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public InvestigatorTerminationProcessor(SerializerFactory serializerFactory) {
