...
/**
 * OrderCompletionProcessor - Mark order as completed and finalize processing
 * Transition: complete_order (processed → completed)
 */
@Component
public class OrderCompletionProcessor implements CyodaProcessor {

    private static final Logger logger = LoggerFactory.getLogger(OrderCompletionProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public OrderCompletionProcessor(SerializerFactory serializerFactory) {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        logger.info("Processing OrderCompletion for request: {}", request.getId());
    ...
    private EntityWithMetadata<OrderEntity> processEntityWithMetadataLogic(
        ...
        logger.debug("Completing order: {}", entity.getOrderId());

        // Mark order as completed
        entity.setComplete(true);

        // Log order completion for audit trail
        logger.info("Order {} completed successfully - petId: {}, quantity: {}, total: {}", 
                entity.getOrderId(), entity.getPetId(), entity.getQuantity(), entity.getTotalAmount());
