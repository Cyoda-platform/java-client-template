...
public class SubscriberProcessor implements CyodaProcessor {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        return serializer.withRequest(request)
                ...
                .validate(this::isValidSubscriber, "Invalid subscriber state")
    ...
    private boolean isValidSubscriber(Subscriber subscriber) {
        // Validate required fields based on POJO isValid method
    ...
    private Subscriber processSubscriberLogic(Subscriber subscriber) {
        ...
        // Actual business logic from prototype processSubscriber method:
        // - Validate contactInfo and preferences
        // - No further automatic processing unless triggered by GameScore events

        // No changes made to the subscriber entity in this processor
        return subscriber;
    }
}
