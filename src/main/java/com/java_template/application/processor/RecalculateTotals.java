 ...
 * total items count, and grand total based on cart line items.
 */
@Component
public class RecalculateTotals implements CyodaProcessor {
    ...
    /**
     * Recalculate line totals for each cart line
     */
        ...
        if (cart.getLines() != null) {
            for (Cart.CartLine line : cart.getLines()) {
                if (line.getPrice() != null && line.getQty() != null) {
                    ...
                    logger.debug("Line total for SKU {}: {} x {} = {}",
    ...
    private void recalculateCartTotals(Cart cart) {
        if (cart.getLines() != null) {
            ...
            logger.debug("Cart totals - Items: {}, Grand total: {}", totalItems, grandTotal);
        } else {
            // Empty cart
