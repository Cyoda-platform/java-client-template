...
/**
 * ABOUTME: Processor that recalculates cart totals including line totals, total items count,
 * and grand total whenever cart lines are modified.
 */
@Component
public class RecalculateTotals implements CyodaProcessor {
    ...
    /**
     * Recalculates all cart totals based on current lines
     */
