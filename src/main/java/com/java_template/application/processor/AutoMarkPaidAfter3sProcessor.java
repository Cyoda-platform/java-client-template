...
/**
 * AutoMarkPaidAfter3sProcessor - Auto-approves dummy payment after delay
 * 
 * Simulates payment processing by waiting approximately 3 seconds
 * then marking the payment as PAID for demo purposes.
 */
@Component
public class AutoMarkPaidAfter3sProcessor implements CyodaProcessor {
    ...
    private EntityWithMetadata<Payment> processPaymentApproval(
        ...
        logger.info("Payment {} auto-approved and marked as PAID for cart {}", 
