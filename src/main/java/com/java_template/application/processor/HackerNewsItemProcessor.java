...
public class HackerNewsItemProcessor implements CyodaProcessor {
    ...
    private HackerNewsItem processEntityLogic(ProcessorSerializer.ProcessorEntityExecutionContext<HackerNewsItem> context) {
        ...
        // Business logic based on functional requirements and entity structure
        // Parsing and validation are already done in the chain
        // Persist HackerNewsItem entity immutably is handled by the framework (modifications to entity are persisted automatically)

        // No additional business logic changes needed as per prototype
