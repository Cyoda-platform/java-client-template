...
@Component
public class ProtocolAmendmentRejectionProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ProtocolAmendmentRejectionProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ProtocolAmendmentRejectionProcessor(SerializerFactory serializerFactory) {
