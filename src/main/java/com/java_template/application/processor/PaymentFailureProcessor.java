...
public class PaymentFailureProcessor implements CyodaProcessor {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        return serializer.withRequest(request)
            ...
            .validate(this::isValidPaymentForFailure, "Invalid payment state for failure")
    ...
    private boolean isValidPaymentForFailure(Payment payment) {
        return payment != null &&
    ...
    private Payment processPaymentFailure(ProcessorSerializer.ProcessorEntityExecutionContext<Payment> context) {
        ...
        logger.info("Marked payment {} as FAILED", payment.getPaymentId());
