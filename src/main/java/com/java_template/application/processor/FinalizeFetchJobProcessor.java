...
@Component
public class FinalizeFetchJobProcessor implements CyodaProcessor {

    private static final Logger logger = LoggerFactory.getLogger(FinalizeFetchJobProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public FinalizeFetchJobProcessor(SerializerFactory serializerFactory) {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        logger.info("Processing FinalizeFetchJob for request: {}", request.getId());
    ...
    private FetchJob processEntityLogic(ProcessorSerializer.ProcessorEntityExecutionContext<FetchJob> context) {
        ...
        try {
            ...
            logger.error("Error in FinalizeFetchJobProcessor: {}", e.getMessage(), e);
        }
        return job;
    }
}
