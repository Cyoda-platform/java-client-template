...
@Component
public class VisitUpdateProcessor implements CyodaProcessor {

    private static final Logger logger = LoggerFactory.getLogger(VisitUpdateProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public VisitUpdateProcessor(SerializerFactory serializerFactory) {
    ...
    private EntityWithMetadata<Visit> processVisitUpdate(
        ...
        logger.debug("Processing update for visit: {}", visit.getVisitId());

        visit.setUpdatedAt(LocalDateTime.now());
        logger.info("Visit {} update processed", visit.getVisitId());
