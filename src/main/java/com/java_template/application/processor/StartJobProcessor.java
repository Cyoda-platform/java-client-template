...
public class StartJobProcessor implements CyodaProcessor {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        logger.info("Starting import job for request: {}", request.getId());
    ...
    private ImportJob processEntityLogic(ProcessorSerializer.ProcessorEntityExecutionContext<ImportJob> context) {
        ...
        InMemoryDataStore.jobsByTechnicalId.put(entity.getTechnicalId(), entity);
        logger.info("Job {} set to RUNNING", entity.getTechnicalId());
        return entity;
    }
}
