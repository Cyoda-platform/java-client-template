...
@Component
public class ProtocolAmendmentApprovalProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ProtocolAmendmentApprovalProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ProtocolAmendmentApprovalProcessor(SerializerFactory serializerFactory) {
