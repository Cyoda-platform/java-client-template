...
@Component
public class ValidatePayment implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ValidatePayment.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ValidatePayment(SerializerFactory serializerFactory) {
    ...
    private EntityWithMetadata<Payment> process(ProcessorSerializer.ProcessorEntityResponseExecutionContext<Payment> context) {
        ...
        logger.info("ValidatePayment completed for entity: {}", entityWithMetadata.metadata().getId());
