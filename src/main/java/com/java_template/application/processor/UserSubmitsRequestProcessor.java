...
public class UserSubmitsRequestProcessor implements CyodaProcessor {
    ...
    public UserSubmitsRequestProcessor(SerializerFactory serializerFactory) {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        log.info("Processing user submission request: {}", request.getId());

        // For now, return a simple success response using the serializer
        // Full implementation would process the adoption request logic
        log.info("User submission processed successfully");
