 ...
 * Processes user activation and sets the user as active
 */
@Component
public class UserActivationProcessor implements CyodaProcessor {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        return serializer.withRequest(request)
                ...
                .map(this::processUserActivationLogic)
                .complete();
    }
    ...
    /**
     * Main business logic for user activation
     */
    private EntityWithMetadata<User> processUserActivationLogic(
        ...
        logger.debug("Processing user activation: {} in state: {}", user.getEmail(), currentState);
