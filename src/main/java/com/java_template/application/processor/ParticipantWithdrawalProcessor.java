...
@Component
public class ParticipantWithdrawalProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ParticipantWithdrawalProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ParticipantWithdrawalProcessor(SerializerFactory serializerFactory) {
