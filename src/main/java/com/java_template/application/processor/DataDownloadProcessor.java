...
public class DataDownloadProcessor implements CyodaProcessor {
    ...
    public DataDownloadProcessor(SerializerFactory serializerFactory, ObjectMapper objectMapper) {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        return serializer.withRequest(request)
                .toEntity(ReportEmail.class) // Using ReportEmail as placeholder
    ...
    private ReportEmail processEntityLogic(ProcessorSerializer.ProcessorEntityExecutionContext<ReportEmail> context) {
        ...
        // Business logic for DataDownloadProcessor is embedded in processDataDownload flow
        // Entity DataDownload not provided so no direct implementation possible
