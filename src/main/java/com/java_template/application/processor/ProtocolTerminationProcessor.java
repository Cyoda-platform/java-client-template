...
@Component
public class ProtocolTerminationProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ProtocolTerminationProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ProtocolTerminationProcessor(SerializerFactory serializerFactory) {
