...
public class PetProcessor implements CyodaProcessor {
    ...
    private Pet processEntityLogic(Pet pet) {
        ...
        logger.info("Pet {} is available for adoption", pet.getName());
        // Business logic as per prototype
        // No modifications to pet entity properties as prototype only logs info
        return pet;
    }
}
