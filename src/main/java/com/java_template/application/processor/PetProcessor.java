...
public class PetProcessor implements CyodaProcessor {
    ...
    private Pet processBusinessLogic(Pet pet) {
        // Implement actual business logic here based on prototype
        // For example, update the status or description based on some condition
        if (pet.getStatus() == null || pet.getStatus().isBlank()) {
            pet.setStatus("new"); // default status
        }
