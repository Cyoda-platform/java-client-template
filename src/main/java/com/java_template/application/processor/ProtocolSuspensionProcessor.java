...
@Component
public class ProtocolSuspensionProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ProtocolSuspensionProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ProtocolSuspensionProcessor(SerializerFactory serializerFactory) {
