...
public class StartCheckoutProcessor implements CyodaProcessor {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        return serializer.withRequest(request)
            .toEntity(Cart.class)
            .validate(this::isValidEntity, "Invalid cart state for starting checkout")
    ...
    private boolean isValidEntity(Cart cart) {
        return cart != null && ("ACTIVE".equals(cart.getStatus()) || "NEW".equals(cart.getStatus())) && cart.getLines() != null && !cart.getLines().isEmpty();
    }
