...
public class ApprovePetProcessor implements CyodaProcessor {
    ...
    public boolean supports(OperationSpecification modelSpec) {
        return "ApprovePetProcessor".equals(modelSpec.operationName()) &&
    ...
    private Pet applyApproveLogic(Pet pet) {
        // Example: Set status to approved
        return new Pet(pet.getId(), pet.getName(), pet.getType(), pet.getAge(), "approved");
    }
