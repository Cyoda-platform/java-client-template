...
/**
 * ABOUTME: Processor for loan approval workflow transition.
 * Handles business logic when a loan is approved.
 */
@Component
public class LoanApprovalProcessor implements CyodaProcessor {

    private static final Logger logger = LoggerFactory.getLogger(LoanApprovalProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;
    private final EntityService entityService;

    public LoanApprovalProcessor(SerializerFactory serializerFactory, EntityService entityService) {
    ...
    private EntityWithMetadata<Loan> processLoanApproval(
        ...
        logger.debug("Approving loan: {} for borrower: {}", loan.getLoanId(), loan.getBorrowerName());
