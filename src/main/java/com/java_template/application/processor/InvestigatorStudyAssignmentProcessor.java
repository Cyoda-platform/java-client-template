...
@Component
public class InvestigatorStudyAssignmentProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(InvestigatorStudyAssignmentProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public InvestigatorStudyAssignmentProcessor(SerializerFactory serializerFactory) {
