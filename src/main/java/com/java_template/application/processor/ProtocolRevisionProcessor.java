...
@Component
public class ProtocolRevisionProcessor implements CyodaProcessor {
    private static final Logger logger = LoggerFactory.getLogger(ProtocolRevisionProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public ProtocolRevisionProcessor(SerializerFactory serializerFactory) {
