 ...
 * Used in Payment workflow transition: start_dummy_payment
 */
@Component
public class CreateDummyPayment implements CyodaProcessor {
    ...
    /**
     * Main business logic to initialize dummy payment
     */
    private EntityWithMetadata<Payment> processPaymentCreation(
        ...
        logger.info("Dummy payment {} created successfully for cart: {}, amount: {}", 
