...
/**
 * ABOUTME: Processor that initializes a dummy payment with INITIATED status
 * and sets up timestamps for the payment creation.
 */
@Component
public class CreateDummyPayment implements CyodaProcessor {
    ...
    private EntityWithMetadata<Payment> processBusinessLogic(
        ...
        logger.info("Dummy payment {} created with amount: {}", payment.getPaymentId(), payment.getAmount());
