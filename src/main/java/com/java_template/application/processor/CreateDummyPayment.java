...
/**
 * CreateDummyPayment Processor - Initializes dummy payment processing
 * 
 * This processor handles:
 * - Setting payment status to INITIATED
 * - Setting provider to DUMMY
 * - Preparing payment for auto-approval
 */
@Component
public class CreateDummyPayment implements CyodaProcessor {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        logger.info("Processing CreateDummyPayment for request: {}", request.getId());
     ...
     */
    private EntityWithMetadata<Payment> createDummyPayment(
        ...
        logger.info("Dummy payment {} created and initiated for cart: {}", 
