...
/**
 * Processor to automatically mark payment as paid after ~3 seconds (dummy implementation)
 */
@Component
public class AutoMarkPaidAfter3s implements CyodaProcessor {
    ...
    /**
     * Auto-mark payment as paid (dummy implementation with 3s delay simulation)
     */
