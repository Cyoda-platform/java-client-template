...
/**
 * ABOUTME: Payment processor that automatically marks payment as PAID after a 3-second delay
 * to simulate payment processing time for demo purposes.
 */
@Component
public class AutoMarkPaidAfter3s implements CyodaProcessor {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        logger.info("Auto-marking payment as PAID for request: {}", request.getId());
    ...
    private EntityWithMetadata<Payment> processPaymentApproval(
        ...
        logger.debug("Processing auto-approval for payment: {}", payment.getPaymentId());
        ...
        try {
            ...
            // Continue with payment approval despite interruption
        }
        ...
        logger.info("Payment {} automatically marked as PAID after 3-second delay", payment.getPaymentId());
