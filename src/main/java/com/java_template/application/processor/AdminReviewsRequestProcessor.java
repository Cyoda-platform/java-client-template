...
public class AdminReviewsRequestProcessor implements CyodaProcessor {
    ...
    public AdminReviewsRequestProcessor(SerializerFactory serializerFactory) {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        log.info("Admin reviewing adoption request: {}", request.getId());

        // For now, return a simple success response using the serializer
        // Full implementation would process the admin review logic
        log.info("Admin review initiated successfully");
