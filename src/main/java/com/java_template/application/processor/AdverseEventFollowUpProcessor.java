...
@Component
public class AdverseEventFollowUpProcessor implements CyodaProcessor {

    private static final Logger logger = LoggerFactory.getLogger(AdverseEventFollowUpProcessor.class);
    private final String className = this.getClass().getSimpleName();
    private final ProcessorSerializer serializer;

    public AdverseEventFollowUpProcessor(SerializerFactory serializerFactory) {
    ...
    public EntityProcessorCalculationResponse process(CyodaEventContext<EntityProcessorCalculationRequest> context) {
        ...
        return serializer.withRequest(request)
                ...
                .map(this::processAdverseEventFollowUp)
                .complete();
    }
    ...
    private EntityWithMetadata<AdverseEvent> processAdverseEventFollowUp(
        ...
        logger.debug("Processing follow-up for adverse event: {}", adverseEvent.getAdverseEventId());

        adverseEvent.setUpdatedAt(LocalDateTime.now());
        logger.info("Adverse event {} follow-up processed", adverseEvent.getAdverseEventId());
