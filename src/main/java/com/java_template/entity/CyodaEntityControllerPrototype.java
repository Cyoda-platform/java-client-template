...
public class CyodaEntityControllerPrototype {
    ...
    public void generateReportAndSendEmail() throws ExecutionException, InterruptedException {
        ...
        // Save report as entity
        entityService.addItem("HourlyReport", ENTITY_VERSION, report).get();
    ...
    private void simulateOrdersBatch(int count) {
        ...
        try {
            CompletableFuture<List<UUID>> idsFuture = entityService.addItems(ENTITY_NAME, ENTITY_VERSION, batch);
