...
public class CyodaEntityControllerPrototype {
    ...
    public ResponseEntity<SignupResponse> signupUser(@Valid @RequestBody SignupRequest request) {
        ...
        CompletableFuture<java.util.UUID> addFuture = entityService.addItem(ENTITY_MODEL_SUBSCRIBER, ENTITY_VERSION, newSubscriber);
    ...
    public ResponseEntity<WeeklyFactSendResponse> sendWeeklyCatFact() {
        ...
        CompletableFuture<java.util.UUID> addCatFactFuture = entityService.addItem(ENTITY_MODEL_CATFACT, ENTITY_VERSION, catFact);
