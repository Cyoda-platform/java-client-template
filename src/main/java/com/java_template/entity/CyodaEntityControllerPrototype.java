...
public class CyodaEntityControllerPrototype {
    ...
    // Subscribers stored in EntityService - we map to/from entityService
    // We store Subscriber objects as entity data with email field
    ...
    public ResponseEntity<ApiResponse> subscribe(@RequestBody @Valid SubscribeRequest request) throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<UUID> addFut = entityService.addItem("Subscriber", ENTITY_VERSION, sub);
        addFut.get();
