...
public class StartJobProcessorTest {
    ...
    @Test
    public void testProcess_marksInProgressAndSetsStartedAtAndPersists() throws Exception {
        ...
        StartJobProcessor processor = new StartJobProcessor(sf, entityService);

        Job job = new Job();
        job.setName("job-start");
        job.setTargetEntity("Opportunity");
        ...
        Method m = StartJobProcessor.class.getDeclaredMethod("processEntityLogic", ProcessorSerializer.ProcessorEntityExecutionContext.class);
