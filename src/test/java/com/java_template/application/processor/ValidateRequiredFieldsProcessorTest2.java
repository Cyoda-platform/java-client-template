...
// This duplicate test ensures invalid payload marks INVALID
public class ValidateRequiredFieldsProcessorTest2 {

    @Test
    public void testValidateInvalidMissingFields() throws Exception {
