...
public class MarkReadyIfFinalCriterionTest {

    @Test
    public void testFinalStatusUpdatesLastUpdated() throws Exception {
        ...
        MarkReadyIfFinalCriterion processor = new MarkReadyIfFinalCriterion(sf);
        Game g = new Game();
        g.setGameId("game-1");
        g.setDate("2025-03-25");
        g.setStatus("final");

        Method m = MarkReadyIfFinalCriterion.class.getDeclaredMethod("processEntityLogic", com.java_template.common.serializer.ProcessorSerializer.ProcessorEntityExecutionContext.class);
        ...
        assertNotNull(out.getLastUpdated());
    }
}
