...
public class SubmitForReviewProcessorTest {
    ...
    @Test
    public void submitForReview_setsInReviewAndUpdatedAt() throws Exception {
        when(serializerFactory.getDefaultProcessorSerializer()).thenReturn(processorSerializer);
        SubmitForReviewProcessor processor = new SubmitForReviewProcessor(serializerFactory);
        ...
        java.lang.reflect.Method method = SubmitForReviewProcessor.class.getDeclaredMethod("processEntityLogic", ProcessorSerializer.ProcessorEntityExecutionContext.class);
