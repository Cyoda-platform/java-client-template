...
public class ScheduleProcessorTest {
    ...
    @Test
    public void testProcess_marksScheduledAndPersists() throws Exception {
        ...
        ScheduleProcessor processor = new ScheduleProcessor(sf, entityService);

        Job job = new Job();
        job.setName("job-schedule");
        ...
        Method m = ScheduleProcessor.class.getDeclaredMethod("processEntityLogic", ProcessorSerializer.ProcessorEntityExecutionContext.class);
