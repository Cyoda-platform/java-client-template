...
class HackerNewsItemValidationCriterionTest {
    ...
    private static class TestProcessorSerializer implements ProcessorSerializer {
        ...
        @Override
        public com.fasterxml.jackson.databind.JsonNode extractPayload(EntityProcessorCalculationRequest request) { return null; }
    ...
    @Test
    void testProcess_ValidatesAndSetsState() {
        ...
        HackerNewsItemValidationCriterion processor = new HackerNewsItemValidationCriterion(factory);
        CyodaEventContextStub ctx = new CyodaEventContextStub();
        ...
        assertEquals(123L, testSerializer.processedEntity.getId());
        assertEquals("story", testSerializer.processedEntity.getType());
    }
