...
public class NotifyProcessorTest {
    ...
    @Test
    public void testProcess_marksNotifiedAndPersists() throws Exception {
        ...
        NotifyProcessor processor = new NotifyProcessor(sf, entityService);
        ...
        Method m = NotifyProcessor.class.getDeclaredMethod("processEntityLogic", ProcessorSerializer.ProcessorEntityExecutionContext.class);
