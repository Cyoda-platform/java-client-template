...
public class CheckoutProcessorTest {
    ...
    @Test
    public void testProcess_checkoutSuccess() throws Exception {
        ...
        CheckoutProcessor processor = new CheckoutProcessor(factory, entityService, objectMapper);
        ...
        Item it = new Item(); it.setProductId("p1"); it.setQuantity(1); it.setUnitPrice(5.0);
        items.add(it);
        order.setItems(items);

        // Mock entityService response for product lookup
        ...
        assertNotNull(resp);
        assertEquals("PendingPayment", order.getStatus());
    }
