...
public class FinalizeFailureProcessorTest {

    @Test
    public void testProcess_marksJobFailedFinalAndPersists() throws Exception {
        ...
        FinalizeFailureProcessor processor = new FinalizeFailureProcessor(sf, entityService);
        ...
        Method m = FinalizeFailureProcessor.class.getDeclaredMethod("processEntityLogic", ProcessorSerializer.ProcessorEntityExecutionContext.class);
        m.setAccessible(true);
        Job result = (Job) m.invoke(processor, ctx);

        assertNotNull(result);
        assertEquals("FAILED_FINAL", result.getStatus());
